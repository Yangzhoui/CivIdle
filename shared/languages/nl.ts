export const NL = {
   ...
   EmpireValueFromResources: "Van Bronnen",
   ...
   EmailDeveloper: "Email Ontwikkelaar",
   Embassy: "Ambassade",
   EmmanuelleCharpentier: "Emmanuelle Charpentier",
   EmperorWuOfHan: "Kijzer Wu of Han",
   EmpireValue: "Rijkwaarde",
   EmpireValueByHour: "Rijkwaarde Per Uur",
   EmpireValueFromBuilding: "Rijkwaarde Van Gebouwen",
   EmpireValueFromBuildingsStat: "Van Gebouwen",
   EmpireValueFromResourcesStat: "Van Bronnen",
   EmpireValueIncrease: "Stijging van de Rijkwaarde",
   English: "Engels",
   Enrichment: "Verrijking",
   EnricoFermi: "Enrico Fermi",
   EstimatedTimeLeftShort: "Grm. Tijd Over",
   EuphratesRiver: "Eufraat",
   EuphratesRiverDesc:
   ...
   ExtraTileInfoTypeEmpireValue: "Rijkwaarde",
